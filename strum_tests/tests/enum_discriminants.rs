...
use strum::{
      DiscriminantOf, Display, EnumDiscriminants, EnumIter, EnumMessage, EnumString, FromRepr, IntoDiscriminant, IntoEnumIterator, VariantArray
};
...
fn simple_test() {
    ...
    let v0 = <<Simple as IntoDiscriminant>::Discriminant as DiscriminantOf<_>>::Enum::Variant0;
    let v1 = <<Simple as IntoDiscriminant>::Discriminant as DiscriminantOf<_>>::Enum::Variant1;
    let roundtrip = vec![v0.discriminant(), v1.discriminant()];

    assert_eq!(roundtrip, discriminants);
...
// impl<U: Foo, V: Bar> DiscriminantOf<Complicated<U, V>> for ComplicatedDiscriminants {
//     type Enum = Complicated<U, V>;
// }

#[test]
fn complicated_test() {
    let _ = <ComplicatedDiscriminants as DiscriminantOf<_>>::Enum::C;
