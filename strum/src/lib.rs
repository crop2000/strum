...
/// A trait for associating the enum generated by [`EnumDiscriminants`] with the 
/// Type of the original enumeration. This trait can be autoderived by `strum_macros`.
pub trait DiscriminantOf<E> {
    type Enum;
}
